      ...
      cfg['installOnly'] =
        value.trim().toLowerCase() === 'true'
          ...
          : value.trim().toLowerCase() === 'false'
            ...
            : ((() => {
                throw new Error(
                  'Input "installOnly" must be a boolean (true/false)',
                );
              })() as any);
    } else {
    ...
    if (value !== undefined) {
      cfg['buildCacheStrategy'] =
        value.trim().length > 0
          ...
          : ((() => {
              throw new Error(
                'Input "buildCacheStrategy" must be a non-empty string',
              );
            })() as any);
    } else {
    ...
    if (value !== undefined) {
      cfg['buildCacheFallbackBranch'] =
        value.trim().length > 0
          ...
          : ((() => {
              throw new Error(
                'Input "buildCacheFallbackBranch" must be a non-empty string',
              );
            })() as any);
    } else {
    ...
    if (value !== undefined) {
      cfg['flow']['test']['toolchain'] =
        value.trim().length > 0
          ...
          : ((() => {
              throw new Error(
                'Input "flow-test-toolchain" must be a non-empty string',
              );
            })() as any);
    } else {
    ...
    if (value !== undefined) {
      cfg['flow']['test']['overrideArgs'] =
        value.trim().length > 0
          ...
          : ((() => {
              throw new Error(
                'Input "flow-test-overrideArgs" must be a non-empty string',
              );
            })() as any);
    } else {
      ...
      cfg['flow']['test']['failFast'] =
        value.trim().toLowerCase() === 'true'
          ...
          : value.trim().toLowerCase() === 'false'
            ...
            : ((() => {
                throw new Error(
                  'Input "flow-test-failFast" must be a boolean (true/false)',
                );
              })() as any);
    } else {
    ...
    if (value !== undefined) {
      cfg['flow']['clippy']['toolchain'] =
        value.trim().length > 0
          ...
          : ((() => {
              throw new Error(
                'Input "flow-clippy-toolchain" must be a non-empty string',
              );
            })() as any);
    } else {
    ...
    if (value !== undefined) {
      cfg['flow']['clippy']['overrideArgs'] =
        value.trim().length > 0
          ...
          : ((() => {
              throw new Error(
                'Input "flow-clippy-overrideArgs" must be a non-empty string',
              );
            })() as any);
    } else {
      ...
      cfg['flow']['clippy']['denyWarnings'] =
        value.trim().toLowerCase() === 'true'
          ...
          : value.trim().toLowerCase() === 'false'
            ...
            : ((() => {
                throw new Error(
                  'Input "flow-clippy-denyWarnings" must be a boolean (true/false)',
                );
              })() as any);
    } else {
    ...
    if (value !== undefined) {
      cfg['flow']['fmt']['toolchain'] =
        value.trim().length > 0
          ...
          : ((() => {
              throw new Error(
                'Input "flow-fmt-toolchain" must be a non-empty string',
              );
            })() as any);
    } else {
    ...
    if (value !== undefined) {
      cfg['flow']['fmt']['overrideArgs'] =
        value.trim().length > 0
          ...
          : ((() => {
              throw new Error(
                'Input "flow-fmt-overrideArgs" must be a non-empty string',
              );
            })() as any);
    } else {
    ...
    if (value !== undefined) {
      cfg['flow']['doc']['toolchain'] =
        value.trim().length > 0
          ...
          : ((() => {
              throw new Error(
                'Input "flow-doc-toolchain" must be a non-empty string',
              );
            })() as any);
    } else {
    ...
    if (value !== undefined) {
      cfg['flow']['doc']['overrideArgs'] =
        value.trim().length > 0
          ...
          : ((() => {
              throw new Error(
                'Input "flow-doc-overrideArgs" must be a non-empty string',
              );
            })() as any);
    } else {
    ...
    if (value !== undefined) {
      cfg['flow']['shear']['toolchain'] =
        value.trim().length > 0
          ...
          : ((() => {
              throw new Error(
                'Input "flow-shear-toolchain" must be a non-empty string',
              );
            })() as any);
    } else {
    ...
    if (value !== undefined) {
      cfg['flow']['shear']['overrideArgs'] =
        value.trim().length > 0
          ...
          : ((() => {
              throw new Error(
                'Input "flow-shear-overrideArgs" must be a non-empty string',
              );
            })() as any);
    } else {
    ...
    if (value !== undefined) {
      cfg['flow']['deny']['toolchain'] =
        value.trim().length > 0
          ...
          : ((() => {
              throw new Error(
                'Input "flow-deny-toolchain" must be a non-empty string',
              );
            })() as any);
    } else {
    ...
    if (value !== undefined) {
      cfg['flow']['deny']['overrideArgs'] =
        value.trim().length > 0
          ...
          : ((() => {
              throw new Error(
                'Input "flow-deny-overrideArgs" must be a non-empty string',
              );
            })() as any);
    } else {
